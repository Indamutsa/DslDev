 ...
 */
package org.example.workflow.ide.contentassist.antlr;
...
import org.example.workflow.ide.contentassist.antlr.internal.InternalWorkflowmodelParser;
import org.example.workflow.services.WorkflowmodelGrammarAccess;

public class WorkflowmodelParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(WorkflowmodelGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, WorkflowmodelGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getStatementAccess().getAlternatives_0(), "rule__Statement__Alternatives_0");
			builder.put(grammarAccess.getRelationalAccess().getAlternatives(), "rule__Relational__Alternatives");
			builder.put(grammarAccess.getConditionElementsAccess().getAlternatives_1(), "rule__ConditionElements__Alternatives_1");
			...
			builder.put(grammarAccess.getByteArrayAccess().getAlternatives(), "rule__ByteArray__Alternatives");
			...
			builder.put(grammarAccess.getServiceWorkflowAccess().getGroup(), "rule__ServiceWorkflow__Group__0");
			builder.put(grammarAccess.getTheClassAccess().getGroup(), "rule__TheClass__Group__0");
			builder.put(grammarAccess.getTheClassAccess().getGroup_2(), "rule__TheClass__Group_2__0");
			...
			builder.put(grammarAccess.getExpressionsModelAccess().getGroup_1(), "rule__ExpressionsModel__Group_1__0");
			builder.put(grammarAccess.getConditionElementsAccess().getGroup(), "rule__ConditionElements__Group__0");
			...
			builder.put(grammarAccess.getRelAttrubutesListAccess().getGroup(), "rule__RelAttrubutesList__Group__0");
			builder.put(grammarAccess.getRelAttrubutesListAccess().getGroup_1(), "rule__RelAttrubutesList__Group_1__0");
			builder.put(grammarAccess.getRelAttributeAccess().getGroup(), "rule__RelAttribute__Group__0");
			...
			builder.put(grammarAccess.getServiceWorkflowAccess().getEntitiesAssignment_0(), "rule__ServiceWorkflow__EntitiesAssignment_0");
			builder.put(grammarAccess.getServiceWorkflowAccess().getOperationsAssignment_1(), "rule__ServiceWorkflow__OperationsAssignment_1");
			builder.put(grammarAccess.getTheClassAccess().getNameAssignment_1(), "rule__TheClass__NameAssignment_1");
			builder.put(grammarAccess.getTheClassAccess().getSuperTypeAssignment_2_1(), "rule__TheClass__SuperTypeAssignment_2_1");
			builder.put(grammarAccess.getTheClassAccess().getAttributesAssignment_4(), "rule__TheClass__AttributesAssignment_4");
			builder.put(grammarAccess.getOperationAccess().getNameAssignment_1(), "rule__Operation__NameAssignment_1");
			builder.put(grammarAccess.getOperationAccess().getParametersAssignment_3(), "rule__Operation__ParametersAssignment_3");
			builder.put(grammarAccess.getOperationAccess().getStatementsAssignment_6(), "rule__Operation__StatementsAssignment_6");
			builder.put(grammarAccess.getVariableAccess().getDeclarationAssignment_0(), "rule__Variable__DeclarationAssignment_0");
			builder.put(grammarAccess.getVariableAccess().getExpressionAssignment_2(), "rule__Variable__ExpressionAssignment_2");
			builder.put(grammarAccess.getUpdateAccess().getEntityAssignment_1(), "rule__Update__EntityAssignment_1");
			builder.put(grammarAccess.getUpdateAccess().getExpressionsAssignment_3(), "rule__Update__ExpressionsAssignment_3");
			builder.put(grammarAccess.getUpdateAccess().getVariableListAssignment_6(), "rule__Update__VariableListAssignment_6");
			builder.put(grammarAccess.getUpdateAccess().getVariableListAssignment_7_1(), "rule__Update__VariableListAssignment_7_1");
			builder.put(grammarAccess.getDeleteAccess().getEntityAssignment_1(), "rule__Delete__EntityAssignment_1");
			builder.put(grammarAccess.getDeleteAccess().getExpressionsAssignment_3(), "rule__Delete__ExpressionsAssignment_3");
			builder.put(grammarAccess.getCreateAccess().getEntityAssignment_1(), "rule__Create__EntityAssignment_1");
			builder.put(grammarAccess.getCreateAccess().getExpressionsAssignment_3(), "rule__Create__ExpressionsAssignment_3");
			builder.put(grammarAccess.getExpressionsModelAccess().getElementsAssignment_0(), "rule__ExpressionsModel__ElementsAssignment_0");
			builder.put(grammarAccess.getExpressionsModelAccess().getElementsAssignment_1_1(), "rule__ExpressionsModel__ElementsAssignment_1_1");
			builder.put(grammarAccess.getConditionElementsAccess().getCompareNameAssignment_0(), "rule__ConditionElements__CompareNameAssignment_0");
			builder.put(grammarAccess.getConditionElementsAccess().getExprAssignment_2(), "rule__ConditionElements__ExprAssignment_2");
			builder.put(grammarAccess.getVariableInitAccess().getNameAssignment_0(), "rule__VariableInit__NameAssignment_0");
			builder.put(grammarAccess.getVariableInitAccess().getExpressionAssignment_2(), "rule__VariableInit__ExpressionAssignment_2");
			...
			builder.put(grammarAccess.getRelAttrubutesListAccess().getValueAssignment_0(), "rule__RelAttrubutesList__ValueAssignment_0");
			builder.put(grammarAccess.getRelAttrubutesListAccess().getValueAssignment_1_1(), "rule__RelAttrubutesList__ValueAssignment_1_1");
			builder.put(grammarAccess.getRelAttributeAccess().getNameAssignment_0(), "rule__RelAttribute__NameAssignment_0");
			builder.put(grammarAccess.getRelAttributeAccess().getReferenceAssignment_2(), "rule__RelAttribute__ReferenceAssignment_2");
			builder.put(grammarAccess.getAttributeAccess().getModificatorAssignment_0(), "rule__Attribute__ModificatorAssignment_0");
			builder.put(grammarAccess.getAttributeAccess().getVariableAssignment_1(), "rule__Attribute__VariableAssignment_1");
			...
			builder.put(grammarAccess.getTypeReferenceAccess().getPrimitiveAssignment_0(), "rule__TypeReference__PrimitiveAssignment_0");
			builder.put(grammarAccess.getTypeReferenceAccess().getEntityAssignment_1(), "rule__TypeReference__EntityAssignment_1");
	...
	@Override
	protected InternalWorkflowmodelParser createParser() {
		InternalWorkflowmodelParser result = new InternalWorkflowmodelParser(null);
