 ...
 * </p>
 * <ul>
 *   <li>{@link org.example.expression.expression.impl.ExpressionsModelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExpressionsModelImpl extends MinimalEObjectImpl.Container implements ExpressionsModel
{
  ...
  {
    return ExpressionPackage.Literals.EXPRESSIONS_MODEL;
  }
  ...
  public EList<AbstractElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<AbstractElement>(AbstractElement.class, this, ExpressionPackage.EXPRESSIONS_MODEL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ExpressionPackage.EXPRESSIONS_MODEL__ELEMENTS:
