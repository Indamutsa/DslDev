...
import org.example.workflow.ide.contentassist.antlr.PartialWorkflowmodelContentAssistParser;
import org.example.workflow.ide.contentassist.antlr.WorkflowmodelParser;
import org.example.workflow.ide.contentassist.antlr.internal.InternalWorkflowmodelLexer;
import org.example.workflow.ui.contentassist.WorkflowmodelProposalProvider;
import org.example.workflow.ui.editor.WorkflowmodelEditor;
import org.example.workflow.ui.labeling.WorkflowmodelDescriptionLabelProvider;
import org.example.workflow.ui.labeling.WorkflowmodelLabelProvider;
import org.example.workflow.ui.outline.WorkflowmodelOutlineTreeProvider;
import org.example.workflow.ui.quickfix.WorkflowmodelQuickfixProvider;
import org.example.workflow.validation.WorkflowmodelValidatorConfigurationBlock;

/**
 * Manual modifications go to {@link WorkflowmodelUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractWorkflowmodelUiModule extends DefaultXbaseUiModule {

	public AbstractWorkflowmodelUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureContentAssistLexer(Binder binder) {
		binder.bind(Lexer.class)
			...
			.to(InternalWorkflowmodelLexer.class);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.example.workflow.parser.antlr.internal.InternalWorkflowmodelLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return WorkflowmodelParser.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalWorkflowmodelLexer.class).toProvider(LexerProvider.create(InternalWorkflowmodelLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return WorkflowmodelValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return WorkflowmodelLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(WorkflowmodelDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return WorkflowmodelOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return WorkflowmodelQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return WorkflowmodelProposalProvider.class;
	}
	...
	public Class<? extends XtextEditor> bindXtextEditor() {
		return WorkflowmodelEditor.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialWorkflowmodelContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Workflowmodel Compare");
	}
