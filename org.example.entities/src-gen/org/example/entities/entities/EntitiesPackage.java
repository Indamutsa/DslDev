...
public interface EntitiesPackage extends EPackage
{
  ...
  /**
   * The feature id for the '<em><b>Suprt Type</b></em>' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int ENTITY__SUPRT_TYPE = 1;
  ...
  /**
   * Returns the meta object for the reference '{@link org.example.entities.entities.Entity#getSuprtType <em>Suprt Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Suprt Type</em>'.
   * @see org.example.entities.entities.Entity#getSuprtType()
   * @see #getEntity()
   * @generated
   */
  EReference getEntity_SuprtType();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '<em><b>Suprt Type</b></em>' reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference ENTITY__SUPRT_TYPE = eINSTANCE.getEntity_SuprtType();
