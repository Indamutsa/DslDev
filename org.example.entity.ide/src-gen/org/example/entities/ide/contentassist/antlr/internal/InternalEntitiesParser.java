...
public class InternalEntitiesParser extends AbstractInternalContentAssistParser {
    ...
    // InternalEntities.g:475:1: rule__Entity__Group_2__1__Impl : ( ( rule__Entity__SuprtTypeAssignment_2_1 ) ) ;
    public final void rule__Entity__Group_2__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalEntities.g:479:1: ( ( ( rule__Entity__SuprtTypeAssignment_2_1 ) ) )
            // InternalEntities.g:480:1: ( ( rule__Entity__SuprtTypeAssignment_2_1 ) )
            {
            // InternalEntities.g:480:1: ( ( rule__Entity__SuprtTypeAssignment_2_1 ) )
            // InternalEntities.g:481:2: ( rule__Entity__SuprtTypeAssignment_2_1 )
            {
             before(grammarAccess.getEntityAccess().getSuprtTypeAssignment_2_1()); 
            // InternalEntities.g:482:2: ( rule__Entity__SuprtTypeAssignment_2_1 )
            // InternalEntities.g:482:3: rule__Entity__SuprtTypeAssignment_2_1
            {
            pushFollow(FOLLOW_2);
            rule__Entity__SuprtTypeAssignment_2_1();
            ...
            state._fsp--;
             ...
             after(grammarAccess.getEntityAccess().getSuprtTypeAssignment_2_1()); 
    ...
    // $ANTLR start "rule__Entity__SuprtTypeAssignment_2_1"
    // InternalEntities.g:737:1: rule__Entity__SuprtTypeAssignment_2_1 : ( ( RULE_ID ) ) ;
    public final void rule__Entity__SuprtTypeAssignment_2_1() throws RecognitionException {
        ...
        try {
            ...
            {
             before(grammarAccess.getEntityAccess().getSuprtTypeEntityCrossReference_2_1_0()); 
            // InternalEntities.g:744:3: ( RULE_ID )
            // InternalEntities.g:745:4: RULE_ID
            {
             before(grammarAccess.getEntityAccess().getSuprtTypeEntityIDTerminalRuleCall_2_1_0_1()); 
            match(input,RULE_ID,FOLLOW_2); 
             after(grammarAccess.getEntityAccess().getSuprtTypeEntityIDTerminalRuleCall_2_1_0_1()); 

            }

             after(grammarAccess.getEntityAccess().getSuprtTypeEntityCrossReference_2_1_0()); 
    ...
    // $ANTLR end "rule__Entity__SuprtTypeAssignment_2_1"
