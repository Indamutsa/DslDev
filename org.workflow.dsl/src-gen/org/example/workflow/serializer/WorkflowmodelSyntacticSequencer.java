...
public class WorkflowmodelSyntacticSequencer extends AbstractSyntacticSequencer {

	protected WorkflowmodelGrammarAccess grammarAccess;
	protected AbstractElementAlias match_ConditionElements_EqualsSignEqualsSignKeyword_1_0_or_ExclamationMarkEqualsSignKeyword_1_1_or_GreaterThanSignEqualsSignKeyword_1_4_or_GreaterThanSignKeyword_1_2_or_LessThanSignEqualsSignKeyword_1_5_or_LessThanSignKeyword_1_3;
	protected AbstractElementAlias match_ExpressionsModel_CommaKeyword_1_0_q;
	...
	protected AbstractElementAlias match_Update_CommaKeyword_7_0_q;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (WorkflowmodelGrammarAccess) access;
		match_ConditionElements_EqualsSignEqualsSignKeyword_1_0_or_ExclamationMarkEqualsSignKeyword_1_1_or_GreaterThanSignEqualsSignKeyword_1_4_or_GreaterThanSignKeyword_1_2_or_LessThanSignEqualsSignKeyword_1_5_or_LessThanSignKeyword_1_3 = new AlternativeAlias(false, false, new TokenAlias(false, false, grammarAccess.getConditionElementsAccess().getEqualsSignEqualsSignKeyword_1_0()), new TokenAlias(false, false, grammarAccess.getConditionElementsAccess().getExclamationMarkEqualsSignKeyword_1_1()), new TokenAlias(false, false, grammarAccess.getConditionElementsAccess().getGreaterThanSignEqualsSignKeyword_1_4()), new TokenAlias(false, false, grammarAccess.getConditionElementsAccess().getGreaterThanSignKeyword_1_2()), new TokenAlias(false, false, grammarAccess.getConditionElementsAccess().getLessThanSignEqualsSignKeyword_1_5()), new TokenAlias(false, false, grammarAccess.getConditionElementsAccess().getLessThanSignKeyword_1_3()));
		match_ExpressionsModel_CommaKeyword_1_0_q = new TokenAlias(false, true, grammarAccess.getExpressionsModelAccess().getCommaKeyword_1_0());
		...
		match_Update_CommaKeyword_7_0_q = new TokenAlias(false, true, grammarAccess.getUpdateAccess().getCommaKeyword_7_0());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_ConditionElements_EqualsSignEqualsSignKeyword_1_0_or_ExclamationMarkEqualsSignKeyword_1_1_or_GreaterThanSignEqualsSignKeyword_1_4_or_GreaterThanSignKeyword_1_2_or_LessThanSignEqualsSignKeyword_1_5_or_LessThanSignKeyword_1_3.equals(syntax))
				emit_ConditionElements_EqualsSignEqualsSignKeyword_1_0_or_ExclamationMarkEqualsSignKeyword_1_1_or_GreaterThanSignEqualsSignKeyword_1_4_or_GreaterThanSignKeyword_1_2_or_LessThanSignEqualsSignKeyword_1_5_or_LessThanSignKeyword_1_3(semanticObject, getLastNavigableState(), syntaxNodes);
			else if (match_ExpressionsModel_CommaKeyword_1_0_q.equals(syntax))
				emit_ExpressionsModel_CommaKeyword_1_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
			...
			else if (match_Update_CommaKeyword_7_0_q.equals(syntax))
				emit_Update_CommaKeyword_7_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     compareName=ID (ambiguity) expr=Expression
	 */
	protected void emit_ConditionElements_EqualsSignEqualsSignKeyword_1_0_or_ExclamationMarkEqualsSignKeyword_1_1_or_GreaterThanSignEqualsSignKeyword_1_4_or_GreaterThanSignKeyword_1_2_or_LessThanSignEqualsSignKeyword_1_5_or_LessThanSignKeyword_1_3(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     elements+=ConditionElements (ambiguity) (rule end)
	 */
	protected void emit_ExpressionsModel_CommaKeyword_1_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     variableList+=VariableInit (ambiguity) '}' ';' (rule end)
	 *     variableList+=VariableInit (ambiguity) '}' (rule end)
	 */
	protected void emit_Update_CommaKeyword_7_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
